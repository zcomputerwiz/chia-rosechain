...
if [ "$NOTARIZE" ]; then
  electron-osx-sign Rose-darwin-x64/Rose.app --platform=darwin \
...
mv Rose-darwin-x64 ../build_scripts/dist/
cd ../build_scripts || exit

DMG_NAME="Rose-$CHIA_INSTALLER_VERSION.dmg"
echo "Create $DMG_NAME"
mkdir final_installer
electron-installer-dmg dist/Rose-darwin-x64/Rose.app Rose-$CHIA_INSTALLER_VERSION \
