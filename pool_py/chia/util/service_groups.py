...
# Embedded file name: chia\util\service_groups.py
from typing import KeysView, Generator
SERVICES_FOR_GROUP = {'all':'chia_harvester chia_timelord_launcher chia_timelord chia_farmer chia_full_node chia_wallet'.split(), 
