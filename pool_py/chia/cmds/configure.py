...
# Embedded file name: chia\cmds\configure.py
...
def configure(root_path, set_farmer_peer, set_node_introducer, set_fullnode_port, set_harvester_port, set_log_level, enable_upnp, set_outbound_peer_count, set_peer_count, testnet):
    ...
    if set_farmer_peer:
        ...
        if set_peer_count is not None:
            ...
            change_made = True
        if not testnet is not None or testnet == 'true' or testnet == 't':
...
@click.pass_context
def configure_cmd(ctx, set_farmer_peer, set_node_introducer, set_fullnode_port, set_harvester_port, set_log_level, enable_upnp, set_outbound_peer_count, set_peer_count, testnet):
    configure(ctx.obj['root_path'], set_farmer_peer, set_node_introducer, set_fullnode_port, set_harvester_port, set_log_level, enable_upnp, set_outbound_peer_count, set_peer_count, testnet)