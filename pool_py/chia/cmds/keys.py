...
# Embedded file name: chia\cmds\keys.py
import click
...
@click.option('--show-mnemonic-seed',
  help='Show the mnemonic seed of the keys', default=False, show_default=True, is_flag=True)
