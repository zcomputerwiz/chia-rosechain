...
# Embedded file name: chia\server\start_farmer.py
import pathlib
...
def service_kwargs_for_farmer(root_path: pathlib.Path, config: Dict, config_pool: Dict, keychain: Keychain, consensus_constants: ConsensusConstants) -> Dict:
    connect_peers = []
