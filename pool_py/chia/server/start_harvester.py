...
# Embedded file name: chia\server\start_harvester.py
import pathlib
...
def service_kwargs_for_harvester(root_path: pathlib.Path, config: Dict, consensus_constants: ConsensusConstants) -> Dict:
    ...
    if config['start_rpc_server']:
        kwargs['rpc_info'] = (
         HarvesterRpcApi, config['rpc_port'])
    return kwargs
