...
const url = 'https://www.blockchain.net';
  ...
  return (
    <html>
      ...
      <body>
        ...
        <Spacer />
        <div className="copyright">Copyright (c) 2021 ChiaChia Network</div>
        <Spacer />
        <VersionsTable>
          {versions?.electron && (
            <tr>
        ...
        <BugReport
          href="https://github.com/snight1983/chia-blockchain/issues"
          target="_blank"
        >
          Report an issue
        </BugReport>
